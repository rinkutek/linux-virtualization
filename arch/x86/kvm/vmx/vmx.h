...
// Define vm_exit_counters structure
struct vm_exit_counters {
    u64 total_exits;         // Total number of exits
    u64 exit_counts[256];    // Array for per-exit-type counts
};

// Declare external counters
extern struct vm_exit_counters counters;

// Declare external exit reason names array
extern const char *vm_exit_reason_names[];
